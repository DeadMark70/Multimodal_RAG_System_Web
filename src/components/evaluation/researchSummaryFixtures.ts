...
export const completeFixture: CampaignResearchSummaryResponse = {
  ...
  evaluation_overhead: { tokens: { input_tokens: 20, output_text_tokens: 10, reasoning_tokens: 5, other_tokens: 0, total_tokens: 35, by_phase: { ragas: 35 }, accounting_status: 'complete', phase_attribution_status: 'complete' }, cost_usd: 0.03, pricing_status: 'complete', evaluator_models: ['ragas'], metric_names: ['faithfulness'], batch_count: 1, retry_count: 0 }, warnings: [],
};
...
export const partialFixture: CampaignResearchSummaryResponse = {
  ...
  evaluation_overhead: { ...completeFixture.evaluation_overhead, cost_usd: null, pricing_status: 'unknown' },
};
