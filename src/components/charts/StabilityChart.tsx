...
const MODE_COLORS: Record<CampaignMode, string> = {
  ...
  router: '#6B46C1',
  graph_raw_current: '#DD6B20',
  graph_provenance_gated: '#DD6B20',
  graph_locator_to_chunk: '#DD6B20',
  graph_locator_claim_gate: '#DD6B20',
  always_no_graph: '#718096',
  always_graph_locator: '#DD6B20',
  router_auto_graph: '#6B46C1',
  oracle_graph_router: '#6B46C1',
  graph_local_first: '#DD6B20',
  graph_global_first: '#DD6B20',
  graph_blended: '#DD6B20',
  graph_path_pruned: '#DD6B20',
  graph_planning_only: '#DD6B20',
};
